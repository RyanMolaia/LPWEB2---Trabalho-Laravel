...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion toggled" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{ route('menuadmin.index') }}">
                    <i class="fa-solid fa-bars "></i>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('cores.index') }}">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow w-100">
                            ...
                            style="background-color: #343a40; height: 60px;">
                                ...
                                <span class="mr-3 fw-bold" style="font-size: 1rem; color: #c9a227;">{{ Auth::user()->name }}</span>
