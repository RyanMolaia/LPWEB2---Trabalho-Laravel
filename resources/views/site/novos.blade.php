...
<div class="container py-5">
   ...
   <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ $busca ? route('site.novos') : route('site.index') }}" class="btn-back">
                <i class="fa fa-arrow-left"></i> Voltar
            </a>

            <form method="GET" 
                action="{{ route('site.novos') }}" 
                class="search-box"
            ...
            <div class="col-md-4">
                <div class="car-card">
                    ...
                    <div class="car-card-body">
                        ...
                        <a href="{{ route('site.carro.detalhes', ['id' => $carro->id, 'origem' => 'novos']) }}" class="btn-gold">Ver Detalhes</a>
                    </div>
                </div>
            </div>
        @empty
