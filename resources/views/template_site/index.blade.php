...
<body>
    ...
    <header class="header_section">
        ...
        <li class="nav-item"><a class="nav-link" href="{{ route('site.index') }}">Loja</a></li>
        <li class="nav-item"><a class="nav-link" href="{{ route('site.novos') }}">Novos</a></li>
        <li class="nav-item"><a class="nav-link" href="{{ route('site.seminovos') }}">Seminovos</a></li>
    </div>
    ...
    <div class="nav-right d-flex">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    @if(Auth::user()->is_admin)
                        <li>
                            <a class="dropdown-item text-danger" href="{{ route('menuadmin.index') }}">
        ...
        @else
            <li class="nav-item"><a class="nav-link fw-semibold" href="{{ route('login') }}">Entrar</a></li>
        @endauth
    </div>
                    </ul>
                </div>
