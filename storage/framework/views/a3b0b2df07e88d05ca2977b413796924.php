...
<div class="container mt-4">
    <div class="card shadow-lg border-0 rounded-4">
        <div class="card-header text-center" 
            ...
            <h5 class="mb-0 fw-bold">Alteração de Modelos</h5>
        </div>

       <div class="card-body" style="background-color: #343a40; color: #c9a227;">
            <form method="POST" action="<?php echo e(route('modelos.alterar')); ?>">
                <?php echo csrf_field(); ?>

                <input type="hidden" name="id" value="<?php echo e($modelos->id); ?>" />
                ...
                <div class="d-flex justify-content-center gap-4 flex-wrap">
                    <div class="mb-3 text-center">
                        ...
                        <input type="text" class="form-control bg-dark text-light border-warning text-center"
                            ...
                            value="<?php echo e(old('nome', $modelos->nome)); ?>" />
                    </div>
                        ...
                        <div class="d-flex">
                            <select id="marca_id" name="marca_id" class="form-select form-control bg-dark text-light border-warning me-2" >
                                ...
                                <?php $__currentLoopData = $marcas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $marca): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php echo e(old('marca_id', $modelos->marca_id) == $marca->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('template_menus.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Workspace_local\Laravel\vendaCarros\resources\views/menuadmin/modelos/alterar.blade.php ENDPATH**/ ?>