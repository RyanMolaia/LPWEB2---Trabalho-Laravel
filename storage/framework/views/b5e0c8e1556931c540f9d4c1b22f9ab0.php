...
<div class="container py-5">
    ...
    <h2 class="text-center mb-4" style="color: #c9a227;">Carros Novos</h2>

   <div class="container">

        <div class="d-flex justify-content-between align-items-center mb-4">

            <a href="<?php echo e($busca ? route('site.novos') : route('site.index')); ?>" class="btn-back">
                <i class="fa fa-arrow-left"></i> Voltar
            </a>

            <form method="GET" 
                action="<?php echo e(route('site.novos')); ?>" 
                class="search-box"
            ...
            <div class="col-md-4">
                <div class="car-card">
                    ...
                    <div class="car-card-body">
                        ...
                        <a href="<?php echo e(route('site.carro.detalhes', ['id' => $carro->id, 'origem' => 'novos'])); ?>" class="btn-gold">Ver Detalhes</a>
                    </div>
                </div>
            </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <p class="text-center text-light">Nenhum carro novo disponível no momento.</p>
        <?php endif; ?>    
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template_site.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Workspace_local\Laravel\vendaCarros\resources\views/site/novos.blade.php ENDPATH**/ ?>