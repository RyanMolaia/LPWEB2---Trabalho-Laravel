...
<div class="container mt-4">
    <div class="card shadow-lg border-0 rounded-4">
        ...
        <div class="card-body" style="background-color: #343a40; color: #d4af37;">
            <form method="POST" action="<?php echo e(route('carros.novo')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="row mb-3">
                        ...
                        <div class="d-flex">
                            <select id="cor_id" name="cor_id" class="form-select form-control bg-dark text-light border-warning me-2" >
                                ...
                                <?php $__currentLoopData = $cores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($cor->id); ?>" <?php echo e(old('cor_id') == $cor->id ? 'selected' : ''); ?>>
                                        <?php echo e($cor->nome); ?>
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="number" class="form-control bg-dark text-light border-warning" 
                               id="ano" name="ano" placeholder="2022" value="<?php echo e(old('ano')); ?>"  />
                    </div>

                    <div class="col-md-2">
                        <label for="quilometragem" class="form-label">Quilometragem</label>
                        <input type="number" class="form-control bg-dark text-light border-warning" 
                               id="quilometragem" name="quilometragem" placeholder="Ex: 45000" value="<?php echo e(old('quilometragem')); ?>"  />
                    </div>
                ...
                <div class="row mb-1">
                      ...
                      <div class="col-md-2">
                        ...
                        <select id="status" name="status"
                                class="form-select form-control bg-dark text-light border-warning me-2">
                            <option value="">Selecione...</option>
                            <option value="Novo" <?php echo e(old('status') == 'Novo' ? 'selected' : ''); ?>>Novo</option>
                            <option value="Seminovo" <?php echo e(old('status') == 'Seminovo' ? 'selected' : ''); ?>>Seminovo</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" class="form-control bg-dark text-light border-warning" 
                               id="valor" name="valor" placeholder="Ex: 95.000,00" value="<?php echo e(old('valor')); ?>"  />
                    </div>
                    <div class="col-md-3">
                        ...
                        <input type="url" class="form-control bg-dark text-light border-warning" 
                               id="imagem_principal" name="imagem_principal" placeholder="https://exemplo.com/imagem1.jpg"
                                value="<?php echo e(old('imagem_principal')); ?>" />
                    </div>
                    <div class="col-md-5">
                        ...
                        <input type="url" class="form-control bg-dark text-light border-warning" 
                               id="outras_imagens" name="outras_imagens" placeholder="https://img1.com, https://img2.com, https://img3.com"
                                value="<?php echo e(old('outras_imagens')); ?>" />
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control bg-dark text-light border-warning" 
                              ...
                              placeholder="Descrição detalhada do veículo..."><?php echo e(old('descricao')); ?></textarea>
                </div>
...
<?php echo $__env->make('template_menus.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Workspace_local\Laravel\vendaCarros\resources\views/menuadmin/carros/cadastrar.blade.php ENDPATH**/ ?>