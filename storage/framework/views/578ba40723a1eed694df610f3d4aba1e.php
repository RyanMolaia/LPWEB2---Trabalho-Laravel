        ...
        <div class="card shadow-lg border-0 rounded-4 login-card">
            <div class="card-body p-5">
                <div class="text-center mb-4">
                    <h4 class="login-title">Esqueceu Senha</h4>
                </div>
...
<?php /**PATH D:\Workspace_local\Laravel\vendaCarros\resources\views/template_autenticacao/esqueceusenha.blade.php ENDPATH**/ ?>