...
<div class="card shadow mt-4 border-0">
    <div class="card-header d-flex justify-content-between align-items-center"
        ...
        <a href="<?php echo e(url('/admin/marcas/cadastrar')); ?>" class="btn btn-outline-light btn-sm"
    ...
    <div class="card-body bg-light">
        <div class="table-responsive">
            <table class="table table-hover align-middle text-center">
                ...
                <tbody>
                    <?php $__currentLoopData = $marcas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $linha): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($linha->id); ?></td>
                            <td><?php echo e($linha->nome); ?></td>
                            <td>
                                <a href="<?php echo e(route('marcas.buscar', $linha->id)); ?>"
                                   class="btn btn-sm"
...
<?php echo $__env->make('template_menus.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Workspace_local\Laravel\vendaCarros\resources\views/menuadmin/marcas/index.blade.php ENDPATH**/ ?>