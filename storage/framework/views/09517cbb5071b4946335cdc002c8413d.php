...
<div class="container mt-4">
    <div class="card shadow-lg border-0 rounded-4">
        <div class="card-header text-center" 
            ...
            <h5 class="mb-0 fw-bold">Alteção de Marca</h5>
        </div>

       <div class="card-body" style="background-color: #343a40; color: #c9a227;">
            <form method="POST" action="<?php echo e(route('marcas.alterar')); ?>">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="id" value="<?php echo e($marcas->id); ?>">
                ...
                <div class="d-flex justify-content-center">
                    <div class="mb-3 w-50 text-center">
                        ...
                        <input type="text" class="form-control bg-dark text-light border-warning text-center"
                            ...
                            value="<?php echo e(old('nome', $marcas->nome)); ?>" />
                    </div>
                </div>
...
<?php echo $__env->make('template_menus.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Workspace_local\Laravel\vendaCarros\resources\views/menuadmin/marcas/alterar.blade.php ENDPATH**/ ?>